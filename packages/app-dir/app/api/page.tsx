...
export default function Page() {
  ...
  return <div>
    ...
    <button className='border p-2' onClick={onClientClick}>Call /api/client</button>
    <button className='border p-2' onClick={onMiddlewareClick}>Call /api/middleware</button>
  </div>
}