...
export type CachedFile =
  ...
  | {
      type: "page";
      /** Absent when Next.js did not write the `.html` file at build time. */
      html?: string;
      json: Object;
      meta?: Meta;
    }
  | {
       ...
       * The RSC payload.
       *
       * Absent when Next.js did not write the `.rsc` file at build time, i.e. for fallback
       * shells and for PPR routes with a postponed state. Those responses have to be
